...
return [
    ...
    'POST' => [
        ...
        '#^/gatepasses/\d+/qr/(?:issue|revoke)$#' => ['gatepass.update'],
        '#^/gatepasses/scan$#' => ['scans.scan'],
        '#^/gatepasses/previsit/validate$#' => ['scans.scan'],
        '#^/visits/\d+/previsit-qr/issue$#' => ['visits.previsit_qr_issue'],
        '#^/visits/\d+/previsit-qr/revoke$#' => ['visits.previsit_qr_revoke'],
